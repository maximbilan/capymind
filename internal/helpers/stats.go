...
type statFunc func(ctx *context.Context, locale translator.Locale, adminStorage firestore.AdminStorage) *string
type feedbackFunc func(ctx *context.Context, locale translator.Locale, feedbackStorage firestore.FeedbackStorage) []string

var wg sync.WaitGroup

func GetTotalUserCount(ctx *context.Context, locale translator.Locale, adminStorage firestore.AdminStorage) *string {
...
func GetTotalActiveUserCount(ctx *context.Context, locale translator.Locale, adminStorage firestore.AdminStorage) *string {
...
func GetTotalNoteCount(ctx *context.Context, locale translator.Locale, adminStorage firestore.AdminStorage) *string {
...
func GetStats(ctx *context.Context, locale translator.Locale, adminStorage firestore.AdminStorage, feedbackStorage firestore.FeedbackStorage) []string {
...
func PrepareFeedback(ctx *context.Context, locale translator.Locale, feedbackStorage firestore.FeedbackStorage) []string {
	var array []string
...
func waitForStatFunction(statFunc statFunc, ctx *context.Context, locale translator.Locale, adminStorage firestore.AdminStorage) *string {
	wg.Add(1)
	ch := make(chan *string)
	go func() {
		defer wg.Done()
...
func waitForFeedback(feedbackFunc feedbackFunc, ctx *context.Context, locale translator.Locale, feedbackStorage firestore.FeedbackStorage) []string {
	wg.Add(1)
	ch := make(chan []string)
	go func() {
		defer wg.Done()
