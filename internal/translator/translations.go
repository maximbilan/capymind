...
const translationsJSON = `{
    "en": {
        ...
        "user_progress_message": "You have made a total of %d entries in your journal. Keep up the great work! 🚀"
    },
    "uk": {
        ...
        "user_progress_message": "Кількість записів у вашому журналі: %d. Чудова робота! Продовжуйте в тому ж дусі! 🚀"
    }
}`
